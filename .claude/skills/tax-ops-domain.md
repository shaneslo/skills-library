---
name: tax-ops-domain
description: Prime brokerage tax-operations domain knowledge. Load when authoring or adapting any content entry, classifying a break, deciding a remediation path, or mapping an income type to a tax form. Holds the break-cause taxonomy, the UI/XML/SQL/plugin routing rules, the income-type to tax-form mappings (1099-DIV, 1099-B, 1042-S, FATCA/CRS), and the three-test asset framework.
---
